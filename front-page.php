...
<main data-page="front">
        ...
        <div class="services__box">
            <div class="services__item services__left" id="TriggerObserv__left" PosLeft>
                ...
                <div class="services__content">
                    ...
                    <div class="services__content__description">Globally evisculate synergistic niche markets whereas
                        timely
                        e-markets. Distinctively formulate timely web-readiness with long-term high-impact
                        infrastructures.
                    </div>
    ...
    <div class="questions__block">
        <div class="questions__content">
            ...
            <div class="questions__subtitle">Prospective functionalities for interactive commun generate economically
                sound
    ...
    <div class="portfolio__block" id="Work">
        <div class="portfolio__heade__box">
            ...
            <div class="portfolio__subtitle">Assertively impact bricks-and-clicks outsourcing after mission-critical
                ROI.
        ...
        <?php if ($posts_count > $posts_limit): ?>
            <a class="portfolio__archive__link"
                href="<?php echo $item_archive_link; ?>"><?php _e('Go to archive', 'hazel'); ?></a>
        <?php endif; ?>
        <?php
        wp_reset_postdata();
        ?>
